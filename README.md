...
Follow this link for a live [version](https://helena-p.github.io/milestone_project_1/).
...
2. I need to know of their events and happenings and what I need to do to participate.
1. I would need to know where to go , the opening hours, and how to get in touch.
...
2. I need to buy tickets.
 ...
 2. Poppins typography is chosen to give a modern, but also a sense of the 1950's era and the old Cadillac on the building. The logo typography, Yellowtail, is matched to the neon sign in the landing site image.
...
### Future implements
Future implementations I would like is an image gallery of the artist/artists when mouse-over the image, and an on-click music sample.
...
## Bugs remaining
1. The navigation dropdown menu is not self closing on smaller devices, and will be improved in the future.
...
1. New customer expectations
    ...
    * 
    * My attention would be drawn to the unexpected and out of the ordinary. The clean landing site differ from other pages.
    ...
    * I  click again on the navbar, or click on the link provided in the text, or scroll further down the pages to the contact information provided in the footer.
...
2. Returning customer
    ...
    * I am mostly interested in the event section and further information 
...
* I want to credit the help and assistance of Daniel Svensson (family member) for solving a bug issue in landing site jumbotron due to Autoprefixer extension
